...
with open('data_timescale.csv', 'a') as file:
    file.write('Timestamp,D1,D2,D3,D4,Author,Value,Corrected_value' + '\n')
...
for i in range(1000): 
    ...
    for j in range(hours_in_year):
       ...
       #writing to files
       with open('data_influx.csv', 'a') as file:
            file.write(record_influx + '\n')
       with open('data_timescale.csv', 'a') as file:
           file.write(record_timescale + '\n')